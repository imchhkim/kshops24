...
if (!defined('APP_STAGE_TITLE')) {
    ...
    // [수정] 커밋 메시지 기본값을 오늘 날짜와 시간(YYMMDD_HH:MM) 조합으로 동적 생성합니다.
    define('DEFAULT_COMMIT_MSG', date('ymd_H:i'));
}
...
<div class="container">
    ...
    <div id="section-step1" class="deploy-card">
        ...
        <div class="cmd-preview">git status && git add . && git commit -m "<?php echo DEFAULT_COMMIT_MSG; ?>"</div>

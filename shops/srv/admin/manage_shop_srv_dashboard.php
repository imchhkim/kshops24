...
?>
    ...
    <?php echo renderPageHeader('서비스/예약 대시보드', 'bi-speedometer2'); ?>
    ...
    <div class="row g-3 mb-4">
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-primary bg-gradient text-white">
                <div class="card-body p-3 p-md-4">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <h6 class="fw-bold m-0 opacity-75">오늘 신규 예약</h6>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-warning bg-gradient text-dark">
                <div class="card-body p-3 p-md-4">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <h6 class="fw-bold m-0 opacity-75">예약 대기</h6>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-info bg-gradient text-white">
                <div class="card-body p-3 p-md-4">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <h6 class="fw-bold m-0 opacity-75">예약 확정</h6>
                        <i class="bi bi-calendar2-check-fill fs-4 opacity-50"></i>
                    </div>
                    <h2 class="fw-bold m-0"><?php echo number_format($counts['confirmed']); ?> <span class="fs-6 fw-normal opacity-75">건</span></h2>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
                <div class="card-body p-3 p-md-4">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <h6 class="fw-bold m-0 text-muted">총 누적 예약</h6>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-header bg-white border-bottom p-3 p-md-4 d-flex justify-content-between align-items-center rounded-top-4">
            <h5 class="fw-bold m-0 text-dark"><i class="bi bi-chat-square-text text-primary me-2"></i>최근 접수된 예약 내역</h5>
        ...
        <div class="card-body p-0">
            <?php if (empty($recent_inquiries)): ?>
                <div class="text-center py-5">
                    ...
                    <h6 class="fw-bold text-dark m-0">최근 접수된 예약가 없습니다.</h6>
                </div>
            <?php else: ?>
                <div class="list-group list-group-flush rounded-bottom-4">
                    <?php foreach ($recent_inquiries as $inq):
                        ...
                        $first_item_name = $item_count > 0 ? htmlspecialchars($items[0]['name'] ?? '서비스명 없음') : '선택된 서비스 없음';
                        if ($item_count > 1) {
